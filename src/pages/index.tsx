  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the power of seamless dining with Restaurant Booking Engine. Your one-stop solution for table reservations and menu management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of seamless dining with Restaurant Booking Engine. Your one-stop solution for table reservations and menu management.`}
            </Text>
            <Box
